...
const prettier = __importStar(require("./prettierFormatter"));
const forge = __importStar(require("./forgeFormatter"));
function formatDocument(document, context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (formatter) {
            case 'prettier':
                return yield prettier.formatDocument(document, context);
            case 'forge':
